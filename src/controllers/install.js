...
installController.mongotest = function (req, res) {
  ...
  const dbUsername = encodeURIComponent(data.username)
  let CONNECTION_URI =
    'mongodb://' + dbUsername + ':' + dbPassword + '@' + data.host + ':' + data.port + '/' + data.database

  if (data.port === '---')
    CONNECTION_URI = 'mongodb+srv://' + dbUsername + ':' + dbPassword + '@' + data.host + '/' + data.database
...
installController.install = function (req, res) {
  ...
  const dbUsername = encodeURIComponent(username)
  let conuri = 'mongodb://' + dbUsername + ':' + dbPassword + '@' + host + ':' + port + '/' + database
  if (port === '---') conuri = 'mongodb+srv://' + dbUsername + ':' + dbPassword + '@' + host + '/' + database
